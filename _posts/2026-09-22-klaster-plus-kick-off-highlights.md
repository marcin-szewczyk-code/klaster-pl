...
Gospodarzem spotkania był **dr inż. Tadeusz Daszczyński** z Wydziału Elektrycznego Politechniki Warszawskiej, kierownik projektu KLASTER+. Po powitaniu uczestników zaprosił przedstawicieli władz Wydziału oraz partnerów projektu do zabrania głosu.
...
***Fot. 4.** Wystąpienie Łukasza Madeja, Prezesa Zarządu ESA Hub Sp. z o.o.*

![Wystąpienie Aleksandry Mościckiej-Studzińskiej, Zastępcy Dyrektora CEZAMAT PW](/assets/posts/2026-09-22-klaster-plus-kick-off-highlights/foto-01.webp)
***Fot. 5.** Wystąpienie Aleksandry Mościckiej-Studzińskiej, Zastępcy Dyrektora CEZAMAT PW.*
...
Następnie **dr inż. Tadeusz Daszczyński** przedstawił założenia projektu KLASTER+, jego cele, strukturę organizacyjną oraz plan realizacji. Projekt koncentruje się na opracowaniu i wdrożeniu nowej funkcjonalności sterownika polowego pracującego w punkcie przyłączenia mikrosieci do sieci operatora systemu dystrybucyjnego. Rozwiązanie ma wspierać dwukierunkową wymianę informacji oraz koordynację pracy lokalnych źródeł OZE, magazynów energii i odbiorników.
...
Po przerwie zaprezentowano zespół projektu KLASTER+ oraz zakres odpowiedzialności poszczególnych osób. Kolejno wystąpili:

- **dr inż. Tadeusz Daszczyński** – kierownik projektu, odpowiedzialny za strategiczne i merytoryczne kierowanie projektem, integrację rezultatów, współpracę z partnerami, przygotowanie wdrożenia i upowszechnianie wyników, a także wyznaczanie kierunków dalszego rozwoju technologii i zespołu KLASTER+.

- **dr hab. inż. Marcin Szewczyk** – odpowiedzialny za integrację części badawczej i wdrożeniowej projektu, przełożenie wyników analiz i modelowania na wymagania funkcjonalne i techniczne sterownika polowego, wsparcie kierownika projektu i zespołu w zakresie podejmowania decyzji merytorycznych i strategicznych.

- **mgr inż. Kamil Przygoda** – odpowiedzialny za przygotowanie sterownika polowego jako platformy przetwarzania brzegowego, implementację algorytmów i funkcji KLASTER+, integrację interfejsów pomiarowych i komunikacyjnych oraz uruchomienie i weryfikację rozwiązania w środowisku automatyki elektroenergetycznej.

- **dr inż. Robert Wójtowicz** – odpowiedzialny za architekturę i rozwój infrastruktury badawczej, integrację środowisk IT i OT, przepływ danych pomiędzy sterownikami, systemami SCADA/HMI i zapleczem obliczeniowym oraz zagadnienia komunikacji, synchronizacji czasu, bezpieczeństwa i segmentacji sieci.

- **dr inż. Łukasz Rokicki** – odpowiedzialny za pozyskanie, przygotowanie i analizę danych dla obiektów referencyjnych, w tym danych dotyczących sieci, źródeł OZE, odbiorów, magazynów energii i układów sterowania, a także za przygotowanie danych wejściowych do modelowania i analiz współpracy mikrosieci z OSD.

- **mgr inż. Michał Połecki** – odpowiedzialny za modelowanie sieci i mikrosieci, opracowanie i ocenę algorytmów współpracy mikrosieci z siecią OSD oraz analizę ich działania w warunkach zakłóceń transmisji danych i zwiększonej elastyczności pracy mikrosieci.
